...
const MainProfile = ({user}) => {
  ...
  const handleUploadCoverImage = e => {
    ...
    axios.post("https://api.imgbb.com/1/upload?key=66ae816553afedddeb69cdc1f1919d81", formData)
      .then(res => {
            ...
            <div >
              ...
              <div className='avatar-img'>
                ...
                <div className='userInfo'>
                  ...
                  <EditProfile user={user} loggedInUser={loggedInUser} ></EditProfile>
                ...
                posts.map(p=><Post id={p._id} p={p}></Post>)
              }
